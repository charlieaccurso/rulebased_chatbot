...
class SupportBot:
  ...
  def welcome(self):
    SupportBot.name = input("Hi, I'm a customer support representative. Welcome to Happy Smiley Face Bank. Before we can help you, I need some information from you. What is your first name and last name? ").lower()
    
    will_help = input("Ok {}, what can I help you with? ".format(SupportBot.name.title())).lower()
